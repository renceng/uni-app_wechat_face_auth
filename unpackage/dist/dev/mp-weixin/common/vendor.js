...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"face_auth","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!**************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/pages.json ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 17 */
/*!*************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/main.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var _regeneratorRuntime = __webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18);function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var regeneratorRuntime = __webpack_require__(/*! ./utils/regenerator-runtime/runtime */ 21),util = __webpack_require__(/*! ./utils/util */ 22),defaultConfig = __webpack_require__(/*! ./config.js */ 23).defaultConfig,extend = __webpack_require__(/*! ./utils/extend.js */ 24).extend;var init = function init(e) {wx.onNetworkStatusChange(function (e) {"none" !== e.networkType && "2g" !== e.networkType || wx.showToast({ title: "网络异常", icon: "none" });}), wx.onMemoryWarning(function () {wx.showToast({ title: "内存告警，有闪退风险", icon: "none" });}), wx.verifyBaseUrl || (wx.verifyBaseUrl = "https://faceid.qq.com"), wx.startVerify = function (e) {if (console.log("startVerify start, send data", e.data), e.data && e.fail && e.success) {if (e.data.endPath) {if (!util.validate(e.data.endPath, "end_path")) {o = { ErrorCode: -100, ErrorMsg: "调用SDK失败，endPath格式错误！" };return void wx.showModal({ title: "提示", content: o.ErrorMsg, showCancel: !1 });}e.fail = function (o) {if (-999 !== o.error_code) {var i = "";i = e.data.endPath.indexOf("?") >= 0 ? e.data.endPath + "&data=" + encodeURIComponent(JSON.stringify(o)) : e.data.endPath + "?data=" + encodeURIComponent(JSON.stringify(o)), console.log(i), wx.navigateTo({ url: i, fail: function fail(e) {console.log(e), wx.showModal({ title: "提示", content: e.errMsg, showCancel: !1 });} });} else wx.navigateBack();}, e.success = function (o) {var i = "";i = e.data.endPath.indexOf("?") >= 0 ? e.data.endPath + "&data=" + JSON.stringify(o) : e.data.endPath + "?data=" + JSON.stringify(o), console.log(i), wx.redirectTo({ url: i, fail: function fail(e) {console.log(e), wx.showModal({ title: "提示", content: e.errMsg, showCancel: !1 });} });};}wx.verifySuccessFunc = e.success, wx.verifyFailureFunc = e.fail, util.validate(e.data.token, "token") ? (console.log("data is ok", e.data), wx.showLoading({ title: "加载中...", mask: !0 }), getCmsConfig(e.data.token, function (o) {if (console.log(o), wx.hideLoading(), 0 === o.ErrorCode) {extend(!0, defaultConfig, o.Data.config);var i = defaultConfig;console.log("final cmsConfig"), console.log(i), wx.verifySysInfo = wx.getSystemInfoSync(), console.log(wx.verifySysInfo);var t = "ios" === wx.verifySysInfo.platform ? i.JustForMp.iOSVerLimit : i.JustForMp.androidVerLimit;if ("devtools" !== wx.verifySysInfo.platform && t && util.compareVersion(t, wx.verifySysInfo.version) > 0) return wx.hideLoading(), void wx.showModal({ title: "提示", content: "\u5F53\u524D\u5FAE\u4FE1\u7248\u672C\u4F4E\u4E8E".concat(t, "\uFF0C\u65E0\u6CD5\u4F7F\u7528\u8BE5\u529F\u80FD\uFF0C\u8BF7\u5347\u7EA7\u5230\u6700\u65B0\u5FAE\u4FE1\u7248\u672C\u540E\u91CD\u8BD5\u3002"), showCancel: !1 });if (wx.verifySysInfo.environment && "wxwork" === wx.verifySysInfo.environment) return wx.showModal({ title: "提示", content: "企业微信暂不支持使用此功能，请使用微信进行操作", showCancel: !1 }), !1;i = reviseCmsConfig("", i), wx.verify_CMSConfig = i, wx.verify_TOKEN = e.data.token, wx.verify_BizData = e.data;if (i.Common.IsWxNative && !i.Common.Flow.includes("Ocr") && i.Common.IsHideIndexWhenNative) {console.log("直接调用微信原生接口");var _o = i.Common.WxVerifyTypeIsVideo,_t = i.Common.WxCheckAliveType;util.startNativeVerify(_o, _t, wx.verifyBaseUrl, e.data.token, wx.verifyFailureFunc, function (o) {var i = { BizToken: e.data.token, ErrorCode: o.ErrorCode, ErrorMsg: o.ErrorMsg };0 === o.ErrorCode ? wx.verifySuccessFunc(i) : wx.verifyFailureFunc(i);});} else console.log("进入验证页面"), wx.navigateTo({ url: "/pages/face/face?isNotice=" + !1 });} else wx.showModal({ title: "提示", content: o.ErrorMsg, showCancel: !1 });})) : wx.showModal({ title: "提示", content: "调用SDK失败,token格式错误！", showCancel: !1 });} else {var o = { ErrorCode: -100, ErrorMsg: "调用SDK失败，wx.startVerify传入参数缺少！" };wx.showModal({ title: "提示", content: o.ErrorMsg, showCancel: !1 });}};},getCmsConfig = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(e, o) {var i, t;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;i = { method: "POST", url: "".concat(wx.verifyBaseUrl, "/api/auth/getConfig?BizToken=").concat(e) };_context.next = 4;return util.requestPromise(i);case 4:t = _context.sent;200 === t.statusCode && t.data.Data && 0 === t.data.ErrorCode ? o({ ErrorCode: 0, Data: t.data.Data }) : t.data.ErrorCode ? o({ ErrorCode: t.data.ErrorCode, ErrorMsg: "\u83B7\u53D6\u914D\u7F6E\u5931\u8D25,".concat(t.data.ErrorMsg) }) : o({ ErrorCode: -104, ErrorMsg: "调用失败，获取配置异常！" });_context.next = 11;break;case 8:_context.prev = 8;_context.t0 = _context["catch"](0);console.log("genConfig catch error", _context.t0), _context.t0.errMsg.indexOf("request:fail Unable to resolve host") >= 0 || _context.t0.errMsg.indexOf("request:fail 似乎已断开与互联网的连接") >= 0 ? o({ ErrorCode: 101, ErrorMsg: "网络异常，请稍后重试" }) : "request:fail url not in domain list" === _context.t0.errMsg ? o({ ErrorCode: -104, ErrorMsg: "接口还未添加到服务器域名，请点击右上角三个点，打开调试模式再试" }) : o({ ErrorCode: -104, ErrorMsg: "调用接口失败: " + _context.t0.errMsg });case 11:case "end":return _context.stop();}}}, _callee, null, [[0, 8]]);}));return function getCmsConfig(_x, _x2) {return _ref.apply(this, arguments);};}(),reviseCmsConfig = function reviseCmsConfig(e, o) {var i = o.Common.Flow,t = !1,n = !1,r = !1,s = !1,a = 0,l = i.indexOf("LiveFour1V1") >= 0 || i.indexOf("LiveAction1V1") >= 0 || i.indexOf("LiveSilence1V1") >= 0;-1 === i.indexOf("Sms") && (t = !0), -1 === i.indexOf("Ocr") && (n = !0), l && (a = i.indexOf("LiveFour1V1") >= 0 ? 0 : i.indexOf("LiveAction1V1") >= 0 ? 1 : 2), l || -1 !== i.indexOf("Sms") || (r = !0), l || -1 !== i.indexOf("Ocr") || (s = !0);var d = { Common: o.Common, protocol: { title: o.Index.ProtocolTitle, content: o.Index.TencentProtocol, clientContent: o.Index.ClientProtocol }, page: { index: { clientName: o.Index.ProjectName, businessName: o.Index.BusinessName, certificationCenter: o.Index.CooperationName, nextBtnName: o.Index.NextBtn, isHideTipsLogo: !o.Common.IsShowLogo, isHideTipsAbout: o.Common.IsHideAbout, protocolTitle: o.Index.ProtocolEntrance }, ocr: { backend: o.Ocr.Backend, sourceType: o.Ocr.SourceType, isAddress: o.Ocr.IsAddress, isManualInput: o.Ocr.IsManualInput, isHideTakePhoto: o.Ocr.IsHideManualInputTakePhotoBtn, isCheckIDInfo: o.Ocr.IsCheckIdInfo, allowModifyType: o.Ocr.AllowModifyType }, livingbody: { silentRecordTime: o.LiveFour1V1.MaxDuration }, success: { successTitle: o.Success.SubTipsName, successTips: o.Success.SuccessTips, isAutoSkip: o.Success.AutoSkip }, sms: {}, failpage: { isShowExitBtn: o.Fail.IsShowQuitBtn, exitBtnTtile: o.Fail.ExitBtnText, RetryBtnText: o.Fail.RetryBtnText } }, runEnv: "release", navTitle: { smsTitle: o.Common.NavTitle.SmsTitle, ocrTitle: o.Common.NavTitle.OcrTitle, livingbodyTitle: o.Common.NavTitle.LivingbodyTitle, resultTitle: o.Common.NavTitle.ResultTitle }, justForJumpVer: { title: o.Common.Title }, about: { title: "关于腾讯云慧眼", content: "腾讯云慧眼由腾讯AI Lab、腾讯优图、腾讯数据平台部提供技术支持。" }, isGetUserLocation: o.Index.IsGetLocation, isHideSmsPage: t, isHideOcrPage: n, livingbodyType: a, isJustOcr: r, isJustSms: s, failInfo: o.Fail.CustomFailInfo };var c = { isHideSmsPage: d.isHideSmsPage, isHideOcrPage: d.isHideOcrPage, isJustSms: d.isJustSms, isJustOcr: d.isJustOcr, navTitle: d.navTitle };if (d.skipConfig = c, 0 !== d.livingbodyType && 1 !== d.livingbodyType) {var f = 4,u = d.page.livingbody.silentRecordTime;u && "number" == typeof u && u > 4 && (f = u), d.page.livingbody.silentRecordTime = f;}var g = d.page.ocr.allowModifyType.split("");return d.page.ocr.isIdnameAllowEdit = "0" === g[0], d.page.ocr.isIdnumberAllowEdit = "0" === g[1], d.page.ocr.isIdaddressAllowEdit = "0" === g[2], console.log(d.page.ocr), d;};module.exports = { init: init };
...
/* 21 */
/*!******************************************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/utils/regenerator-runtime/runtime.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 22 */
/*!*******************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/utils/util.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var _regeneratorRuntime = __webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18);function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var regeneratorRuntime = __webpack_require__(/*! ./regenerator-runtime/runtime */ 21);function compareVersion(e, r) {e = e.split("."), r = r.split(".");for (var o = Math.max(e.length, r.length); e.length < o;) {e.push("0");}for (; r.length < o;) {r.push("0");}for (var t = 0; t < o; t++) {var s = parseInt(e[t]),a = parseInt(r[t]);if (s > a) return 1;if (s < a) return -1;}return 0;}var requestPromise = function requestPromise(e) {var r = e.url,_e$method = e.method,o = _e$method === void 0 ? "POST" : _e$method,t = e.data,_e$header = e.header,s = _e$header === void 0 ? { "Content-Type": "application/json" } : _e$header;return console.log("requestPromise start:", r, t), new Promise(function (e, a) {wx.request({ url: r, method: o, data: t, header: s, success: function success(r) {console.log("requestPromise success:", r), e(r);}, fail: function fail(e) {console.log("requestPromise error:", e), a(e);} });});},request = function request(e, r) {var o = e.url,_e$method2 = e.method,t = _e$method2 === void 0 ? "POST" : _e$method2,s = e.data,_e$header2 = e.header,a = _e$header2 === void 0 ? { "Content-Type": "application/json" } : _e$header2;console.log("requestPromise start:", o, s);try {wx.request({ url: o, method: t, data: s, header: a, success: function success(e) {console.log("request success:", e), 200 === e.statusCode && e.data ? 0 === e.data.ErrorCode ? r({ ErrorCode: 0, Data: e.data.Data }) : r({ ErrorCode: e.data.ErrorCode, ErrorMsg: e.data.ErrorMsg, Data: e.data.Data }) : r({ ErrorCode: -107, ErrorMsg: "request请求异常，请稍后重试" });}, fail: function fail(e) {console.log("request error:", e), e.errMsg.indexOf("request:fail Unable to resolve host") >= 0 || e.errMsg.indexOf("request:fail 似乎已断开与互联网的连接") >= 0 ? r({ ErrorCode: 101, ErrorMsg: "网络异常，请稍后重试" }) : r({ ErrorCode: -107, ErrorMsg: "request请求异常，请稍后重试" });} });} catch (e) {console.log("request error:", e), r({ ErrorCode: -107, ErrorMsg: "request请求异常" });}},uploadFile = function uploadFile(e, r) {var _this = this;console.log(e), wx.uploadFile({ url: e.url, filePath: e.filePath, name: "file", formData: e.data, success: function success(e) {if (console.log("uploadFile| ", e), 200 === e.statusCode) {console.log(e);var o = JSON.parse(e.data);console.log("resTemp"), console.log(o), 0 === o.ErrorCode ? (console.log(_this.data), r({ ErrorCode: 0, Data: o })) : r({ ErrorCode: o.ErrorCode, ErrorMsg: "上传视频失败，" + o.ErrorMsg });} else r({ ErrorCode: 101, ErrorMsg: "上传视频失败 " + e.statusCode });}, fail: function fail(e) {console.log("upload img fail", e), r({ ErrorCode: 101, ErrorMsg: "上传视频失败, " + e.errMsg });} }).onProgressUpdate(function (e) {_this.setData({ "livingbody.uploadProcess": e.progress - 10 < 0 ? 0 : e.progress - 10 }), console.log("progress", e.progress), console.log("already upload data", e.totalBytesSent), console.log("all upload data", e.totalBytesExpectedToSend);});},validate = function validate(e, r) {switch (r) {case "signature":return /^\S{74}={2}$/.test(e);case "appid":return "string" == typeof e && /^\d{4}$/.test(e);case "uid":return e;case "sms_phone":return /^1\d{10}$/.test(e);case "sms_verifyCode":return /^\d{4}$/.test(e);case "idcard":return IDNumberValid(e);case "idname":return e && !e.match(/[A-z0-9]/g);case "idaddress":return !!e;case "end_path":return /^\//.test(e);case "token":return /^[a-zA-Z0-9-]{36}$/.test(e);}},showModal = function showModal(e, r) {wx.showModal({ title: e, content: r.replace(/(^\s*)|(\s*$)/g, ""), showCancel: !1, confirmText: "我知道了", confirmColor: "#2d72f1", success: function success(e) {e.confirm || e.cancel;} });},IDNumberValid = function IDNumberValid(e) {if (!e || !/^\d{6}(18|19|20)?\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)$/i.test(e)) return !1;if (!{ 11: "北京", 12: "天津", 13: "河北", 14: "山西", 15: "内蒙古", 21: "辽宁", 22: "吉林", 23: "黑龙江 ", 31: "上海", 32: "江苏", 33: "浙江", 34: "安徽", 35: "福建", 36: "江西", 37: "山东", 41: "河南", 42: "湖北 ", 43: "湖南", 44: "广东", 45: "广西", 46: "海南", 50: "重庆", 51: "四川", 52: "贵州", 53: "云南", 54: "西藏 ", 61: "陕西", 62: "甘肃", 63: "青海", 64: "宁夏", 65: "新疆", 71: "台湾", 81: "香港", 82: "澳门", 91: "国外" }[e.substr(0, 2)]) return !1;if (18 === e.length) {e = e.split("");var r = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2],o = [1, 0, "X", 9, 8, 7, 6, 5, 4, 3, 2];var t = 0,s = 0,a = 0;for (var _o = 0; _o < 17; _o++) {t += (s = e[_o]) * (a = r[_o]);}var l = o[t % 11];if ("x" === e[17] || "X" === e[17]) return l === e[17].toUpperCase();if (l !== parseInt(e[17])) return !1;}return !0;},startNativeVerify = function startNativeVerify(e, r, o, t, s, a) {var l = e ? "startFacialRecognitionVerifyAndUploadVideo" : "startFacialRecognitionVerify";getUserIdKey(o, t, s, function (s) {console.log("获取userIdKey成功:", s);var i = wx.startFacialRecognitionVerify;e && (i = wx.startFacialRecognitionVerifyAndUploadVideo), i({ userIdKey: s, checkAliveType: r, success: function success(e) {var r = e.verifyResult;getWxResult(o, t, r, function (e) {console.log(e), a(e);}), reportMonitor(t, l, 0);}, fail: function fail(e) {if (90100 === e.errCode) ;else if (e.verifyResult) {var _r = e.verifyResult;getWxResult(o, t, _r, function (e) {console.log(e), reportMonitor(t, l, e.ErrorCode || -1), a(e);});} else wx.showModal({ title: "提示", content: "验证失败, " + JSON.stringify(e), showCancel: !1 }), e.errMsg && -1 === e.errMsg.indexOf("开发者工具") && (reportError(t, l, e), reportMonitor(t, l, e.errCode || -1));} });});},getUserIdKey = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(e, r, o, t) {var s, a;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;s = { url: "".concat(e, "/api/liveness/getWxUserIdKey?BizToken=").concat(r) };wx.showLoading({ title: "加载中...", mask: !0 });_context.next = 5;return getUserIdKeyRequest(s);case 5:a = _context.sent;wx.hideLoading(), t(a);_context.next = 12;break;case 9:_context.prev = 9;_context.t0 = _context["catch"](0);console.log(_context.t0), wx.hideLoading(), 15 === _context.t0.ErrorCode || 14 === _context.t0.ErrorCode ? (15 === _context.t0.ErrorCode ? _context.t0.ErrorMsg = "当前BizToken已过期，请重试" : 14 === _context.t0.ErrorCode && (_context.t0.ErrorMsg = "当前BizToken已验证完成"), o({ BizToken: r, ErrorCode: _context.t0.ErrorCode, ErrorMsg: _context.t0.ErrorMsg })) : -1 === _context.t0.ErrorCode ? wx.showModal({ title: "提示", content: _context.t0.ErrorMsg, showCancel: !1 }) : wx.showModal({ title: "提示", content: _context.t0.ErrorMsg, confirmText: "重试", confirmColor: "#2d72f1", success: function success(s) {s.confirm && getUserIdKey(e, r, o, t);} });case 12:case "end":return _context.stop();}}}, _callee, null, [[0, 9]]);}));return function getUserIdKey(_x, _x2, _x3, _x4) {return _ref.apply(this, arguments);};}(),getUserIdKeyRequest = function getUserIdKeyRequest(e) {return console.log("\u8BF7\u6C42 ".concat(e.url)), new Promise(function (r, o) {try {wx.request({ url: e.url, method: "POST", data: {}, success: function success(e) {console.log("request success:", e.data), 0 === e.data.ErrorCode ? r(e.data.Data.UserIdKey) : o(e.data);}, fail: function fail(e) {console.log("requestPromise error:", e), e.errMsg.indexOf("request:fail Unable to resolve host") >= 0 || e.errMsg.indexOf("request:fail 似乎已断开与互联网的连接") >= 0 ? o({ ErrorCode: 101, ErrorMsg: "网络异常，请稍后重试" }) : "request:fail url not in domain list" === e.errMsg ? o({ ErrorCode: -1, ErrorMsg: "接口还未添加到服务器域名，请点击右上角三个点，打开调试模式再试" }) : o({ ErrorCode: 101, ErrorMsg: e.errMsg });} });} catch (e) {console.log(Raven.captureException(e) + "捕获error");}});},getWxResult = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(e, r, o, t) {var s;return _regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.prev = 0;wx.showLoading({ title: "加载中...", mask: !0 });_context2.next = 4;return getWxResultRequest(e, r, o);case 4:s = _context2.sent;wx.hideLoading(), t(s);_context2.next = 11;break;case 8:_context2.prev = 8;_context2.t0 = _context2["catch"](0);console.log(_context2.t0), wx.hideLoading(), -1 === _context2.t0.ErrorCode ? wx.showModal({ title: "提示", content: _context2.t0.ErrorMsg, showCancel: !1 }) : wx.showModal({ title: "提示", content: _context2.t0, confirmText: "重试", confirmColor: "#2d72f1", showCancel: !1, success: function success(s) {s.confirm && getWxResult(e, r, o, t);} });case 11:case "end":return _context2.stop();}}}, _callee2, null, [[0, 8]]);}));return function getWxResult(_x5, _x6, _x7, _x8) {return _ref2.apply(this, arguments);};}(),getWxResultRequest = function getWxResultRequest(e, r, o) {return console.log("\u8BF7\u6C42 ".concat(e, "/api/liveness/getWxResult?BizToken=").concat(r)), new Promise(function (t, s) {wx.request({ url: "".concat(e, "/api/liveness/getWxResult?BizToken=").concat(r), method: "POST", data: { VerifyResult: o }, success: function success(e) {console.log("request success:", e.data), e.data.ErrorCode, t(e.data);}, fail: function fail(e) {console.log("requestPromise error:", e), e.errMsg.indexOf("request:fail Unable to resolve host") >= 0 || e.errMsg.indexOf("request:fail 似乎已断开与互联网的连接") >= 0 ? s({ ErrorCode: 101, ErrorMsg: "网络异常，请稍后重试" }) : "request:fail url not in domain list" === e.errMsg ? s({ ErrorCode: -1, ErrorMsg: "接口还未添加到服务器域名，请点击右上角三个点，打开调试模式再试" }) : s({ ErrorCode: 101, ErrorMsg: e.errMsg });} });});};var reportError = function reportError(e, r, o, t) {var s = { tag: r, error: o, source: "miniprogram" };try {s.system = wx.getSystemInfoSync();} catch (e) {}return t && (s.extra = t), console.log("上报错误：", s), new Promise(function (r, o) {wx.request({ url: "".concat(wx.verifyBaseUrl, "/api/report/reportError"), method: "POST", data: { token: e, errorData: JSON.stringify(s) }, success: function success(e) {r(e);}, fail: function fail(e) {o(e);} });});},reportMonitor = function reportMonitor(e, r, o) {return new Promise(function (t, s) {wx.request({ url: "".concat(wx.verifyBaseUrl, "/api/report/reportMonitor"), method: "POST", data: { token: e, pathName: r, platForm: 2, errorCode: String(o) }, success: function success(e) {t(e);}, fail: function fail(e) {s(e);} });});},checkIsSupportFacialRecognition = function checkIsSupportFacialRecognition(e, r, o) {wx.checkIsSupportFacialRecognition({ checkAliveType: r, success: function success() {o && o();}, fail: function fail(o) {wx.showModal({ title: "提示", content: o.errMsg || "当前设备不支持人脸核身操作，请更换设备后重试", showCancel: !1 }), o.errMsg && -1 === o.errMsg.indexOf("开发者工具") && reportError(e, "checkIsSupportFacialRecognition", o, { checkAliveType: r });} });};module.exports = { requestPromise: requestPromise, validate: validate, compareVersion: compareVersion, showModal: showModal, request: request, uploadFile: uploadFile, startNativeVerify: startNativeVerify, reportError: reportError, reportMonitor: reportMonitor, checkIsSupportFacialRecognition: checkIsSupportFacialRecognition };

/***/ }),
/* 23 */
/*!***************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/config.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

var defaultConfig = { Common: { Title: "腾讯云慧眼", IsShowLogo: !0, Flow: ["LiveSilence1V1"], RedirectUrl: "/clearCookie", NavTitle: { SmsTitle: "短信验证", OcrTitle: "上传身份证", LivingbodyTitle: "录制视频", ResultTitle: "验证结果" }, IsWxNative: !1, IsHideIndexWhenNative: !1, WxCheckAliveType: 2, IsWxNativeMod: 0, WxVerifyTypeIsVideo: !1 }, JustForMp: { iOSVerLimit: "6.6.7", androidVerLimit: "6.7.2" }, Index: { ProtocolTitle: "实名核身用户须知", TencentProtocol: '<p>本服务由腾讯实名核身技术方案"腾讯慧眼"提供技术支持。您在接受服务过程中，需要调用您的手机摄像头，并且根据业务场景的不同，需要读取您的身份证个人信息，包括姓名、性别、民族、出生日期、常住户口所在地住址、公民身份号码、本人相片、证件的有效期和签发机关等信息，或者截取您的脸部图像和认证视频，从而实现身份比对。</p><p>如您使用不成功，请确保您已经按照要求正确使用本服务，或者向为您办理业务的机构咨询其他办理渠道。</p>', ClientProtocol: "客户侧协议内容", ProjectName: "云智慧眼", BusinessName: "实名实人认证", CooperationName: "合作方文案", IsHideAbout: !1, NextBtn: "快速验证", ProtocolEntrance: "全部协议", IsGetLocation: !0 }, Sms: {}, Ocr: { IsManualInput: !0, Backend: !1, AllowModifyType: "100", IsAddress: !1, IsCheckIdInfo: !1, SourceType: 2, IsHideManualInputTakePhotoBtn: !1 }, LiveFour1V1: { MaxDuration: 4, DetailType: !1, ForceWatchVideoTime: 5, ImportantTips: "" }, LiveAction1V1: {}, LiveSilence1V1: {}, Fail: { IsShowQuitBtn: !1, ExitBtnText: "退出实名认证", RetryBtnText: "重新验证", CustomFailInfo: {} }, Success: { SubTipsName: "验证成功", SuccessTips: "请点击下一步继续您的操作", AutoSkip: !1 } },sysFailInfo = { 610: { msg: "脸部未完整露出", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-noface.png", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 657: { msg: "脸离屏幕太左", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-tooleft.png", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 658: { msg: "脸离屏幕太右", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-tooright.png", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 663: { msg: "未能检测到完整人脸", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-tooright.png", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 659: { msg: "光线太暗", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-toodark.png", tips1: "建议您调整录制环境，保证光线适中", tips2: "" }, 660: { msg: "光线太强", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-toobright.png", tips1: "建议您调整录制环境，保证光线适中", tips2: "" }, 608: { msg: "视频声音太小", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-nosound.png", tips1: "请用清晰洪亮的普通话，匀速缓慢朗读四个数字", tips2: "" }, 611: { msg: "声音识别失败", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-nosound.png", tips1: "请用清晰洪亮的普通话，匀速缓慢朗读四个数字", tips2: "" }, 612: { msg: "未检测到声音", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-nosound.png", tips1: "请用清晰洪亮的普通话，匀速缓慢朗读四个数字", tips2: "" }, 609: { msg: "嘴唇动作幅度过小", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-openmouse.png", tips1: "朗读时尽量使嘴唇动作明显变化，", tips2: "动作放慢并确保画面清晰" }, 652: { msg: "未检测到第一个动作", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-lowpixel.png", tips1: "建议您动作频率放慢一些", tips2: "" }, 653: { msg: "未检测到闭眼动作", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-openeye.png", tips1: "建议您闭眼频率放慢一些", tips2: "" }, 654: { msg: "未检测到张嘴动作", img: "http://beta.gtimg.com/GodIdent/huiyan/img/ico-fail-openmouse.png", tips1: "建议您张大嘴，动作放慢一些", tips2: "" }, 1600: { msg: "视频录制时间过短", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 1601: { msg: "实人检测失败", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 1602: { msg: "实人检测未达到通过标准", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 651: { msg: "疑似非真人录制", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 603: { msg: "视频实人比对没通过", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 604: { msg: "比对相似度未达到通过标准", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 602: { msg: "视频实人检测没通过", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 823: { msg: "图像比对没通过", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 824: { msg: "比对相似度未达到通过标准", img: "", tips1: "请更换背景环境录制", tips2: "避免背景中有反光、边框", isTips1Color: !0 }, 655: { msg: "脸离屏幕太近", img: "", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 656: { msg: "脸离屏幕太远", img: "", tips1: "建议您调整脸部位置，或录制角度", tips2: "" }, 650: { msg: "活体检测调用失败", img: "", tips1: "给您造成不便深表抱歉，建议您稍后重试", tips2: "" }, 606: { msg: "身份证照片信息拉取失败", img: "", tips1: "如多次出现该错误，请联系相关工作人员，提供身份证号，看证件库是否有您照片", tips2: "" }, 9999: { msg: "服务器返回异常501/504", img: "", tips1: "", tips2: "" } };module.exports = { sysFailInfo: sysFailInfo, defaultConfig: defaultConfig };

/***/ }),
/* 24 */
/*!*********************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/utils/extend.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

var getProto = Object.getPrototypeOf || function (t) {return t.__proto__;},hasOwn = Object.prototype.hasOwnProperty,fnToString = hasOwn.toString,ObjectFunctionString = fnToString.call(Object),isPlainObject = function isPlainObject(t) {var n, o;return !(!t || "[object Object]" !== toString.call(t)) && (!(n = getProto(t)) || "function" == typeof (o = hasOwn.call(n, "constructor") && n.constructor) && fnToString.call(o) === ObjectFunctionString);},isFunction = function isFunction(t) {return "function" == typeof t;},extend = function extend() {var t,n,o,r,e,i,c = arguments[0] || {},a = 1,u = arguments.length,f = !1;for ("boolean" == typeof c && (f = c, c = arguments[a] || {}, a++), "object" == typeof c || isFunction(c) || (c = {}), a === u && (c = this, a--); a < u; a++) {if (null != (t = arguments[a])) for (n in t) {o = c[n], c !== (r = t[n]) && (f && r && (isPlainObject(r) || (e = Array.isArray(r))) ? (e ? (e = !1, i = o && Array.isArray(o) ? o : []) : i = o && isPlainObject(o) ? o : {}, c[n] = extend(f, i, r)) : void 0 !== r && (c[n] = r));}}return c;};module.exports = { extend: extend };
...
/* 35 */
/*!********************************************************************************************!*\
  !*** C:/Users/adminVarstar/Desktop/app/face_auth/wxcomponents/verify_mpsdk/index/index.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var _regeneratorRuntime = __webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18);function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var regeneratorRuntime = __webpack_require__(/*! ../utils/regenerator-runtime/runtime */ 21),
util = __webpack_require__(/*! ../utils/util */ 22);
var sysFailInfo = __webpack_require__(/*! ../config */ 23).sysFailInfo,
BASE_URL = "";
var main = __webpack_require__(/*! ../main */ 17);
...
Page({
  ...
  onLoad: function onLoad(i) {var _this = this;
    ...
    console.log("is not notice"), this.data.cmsConfig.isGetUserLocation && this.getUserLocation(), wx.getSystemInfo({
      success: function success(i) {
        ...
        i.screenHeight > 700 && o && _this.setData({
          isInfinityDisplay: !0,
  ...
  getTheNotice: function getTheNotice() {var _this2 = this;
    var i = {
  ...
  showErrorToast: function showErrorToast(i) {var _this4 = this;
  ...
  checkNetWork: function checkNetWork(i) {
    var o = this;
    wx.getNetworkType({
  ...
  checkRecordNetworkOk: function checkRecordNetworkOk(i, o) {
    wx.getNetworkType({
      success: function success(e) {
  ...
  returnAllCheckNetWork: function returnAllCheckNetWork(i) {
    wx.getNetworkType({
  ...
  isNotAllowClick: function isNotAllowClick() {
    var i = +new Date();
  ...
  exitVerify: function exitVerify(i) {
  ...
  exitVerifyFail: function exitVerifyFail(i) {
  ...
  switchIndexRule: function switchIndexRule() {
    this.setData({
      index_rule: !this.data.index_rule });

  },
  switchAboutDlg: function switchAboutDlg() {
    this.setData({
  ...
  getUserLocation: function getUserLocation() {
    ...
    wx.getLocation({
      ...
      success: function success(o) {
        ...
        var e = {
          url: BASE_URL + "/api/auth/saveLocation?BizToken=".concat(i.data.token),
          data: {
        ...
        util.request(e, function (o) {
          if (0 === o.ErrorCode) console.log("Report location success!");else
          {
  ...
  startNativeVerify: function startNativeVerify() {var _this5 = this;
    console.log("直接调用微信原生接口");
    var i = this.data.cmsConfig,
    o = i.Common.WxVerifyTypeIsVideo,
    e = i.Common.WxCheckAliveType;
    util.startNativeVerify(o, e, BASE_URL, this.data.token, this.exitVerifyFail, function (i) {
      var o = {
        BizToken: _this5.data.token,
        ErrorCode: i.ErrorCode,
        ErrorMsg: i.ErrorMsg };

      0 === i.ErrorCode ? _this5.exitVerify(o) : _this5.exitVerifyFail(o);
    });
  },
  indexToNext: function () {var _indexToNext = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {var i;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              ...
              }case 1:case "end":return _context.stop();}}}, _callee, this);}));function indexToNext() {return _indexToNext.apply(this, arguments);}return indexToNext;}(),

  phoneNumChanged: function phoneNumChanged(i) {
    this.setData({
      "sms.hintError": "" });
  ...
  sendVerifyCodeReq: function sendVerifyCodeReq() {
    if (!this.isNotAllowClick()) {
      ...
      this.checkNetWork(function () {
        var o = {
          url: "".concat(BASE_URL, "/api/common/sendSmsCode?BizToken=").concat(i.data.token),
          data: {
  ...
  verifyCodeChanged: function verifyCodeChanged(i) {
    this.setData({
      "sms.hintError": "" }),
  ...
  smsToNext: function smsToNext() {
    if (!this.isNotAllowClick()) {
      var i = this;
      this.checkNetWork(function () {
        console.log(i.data.sms.phoneNum + " | " + i.data.sms.verifyCode);
        var o = {
          url: "".concat(BASE_URL, "/api/common/verifySmsCode?BizToken=").concat(i.data.token),
          data: {
            PhoneNum: i.data.sms.phoneNum,
  ...
  idcartManualInputChanged: function idcartManualInputChanged(i) {
    var o = i.detail.value;
    this.data.ocr.idcard = o, this.manualInputChanged();
  },
  idnameManualInputChanged: function idnameManualInputChanged(i) {
    var o = i.detail.value;
    this.data.ocr.idname = o, this.manualInputChanged();
  },
  manualInputChanged: function manualInputChanged(i) {
    this.setData({
      "ocr.hintError": "" });
  ...
  manualInputGoNext: function manualInputGoNext() {
    this.ocrCommonInputGoNext(!0);
  },
  ocrCommonInputGoNext: function ocrCommonInputGoNext(i) {
    var o = this;
    this.checkNetWork(function () {
      o.data.cmsConfig;
      wx.showLoading({
      ...
      "android" === wx.verifySysInfo.platform && (e = 300), setTimeout(function () {
        var e = {
          url: "".concat(BASE_URL, "/api/ocr/updateidinfo?BizToken=").concat(o.data.token),
          data: {
  ...
  ocrGoNext: function ocrGoNext(i) {var _this6 = this;
    var o = this;
    if (o.data.cmsConfig.page.ocr.isCheckIDInfo) {
      var e = {
        url: "".concat(BASE_URL, "/api/ocr/checkidinfo?BizToken=").concat(this.data.token),
        data: {
          Name: this.data.ocr.idname,
          IdCard: this.data.ocr.idcard } };


      util.request(e, function (e) {
        if (0 !== e.ErrorCode) {
          if (tokenExceptionArr.includes(e.ErrorCode)) return void o.exitVerifyFail(e);
          var t = {
            "ocr.hintError": e.ErrorMsg };
  ...
  manualInputTakePhone: function manualInputTakePhone() {
    this.setData({
  ...
  ocrStartTakePhoto: function ocrStartTakePhoto() {
    var i = this;
    this.checkNetWork(function () {
      i.setData({
  ...
  takePhotoWithCamera: function takePhotoWithCamera() {var _this7 = this;
    var i = this;
    wx.createCameraContext().takePhoto({
      quality: "noraml",
      success: function success(o) {
        console.log(o.tempImagePath), _this7.setData({
  ...
  startUploadAndOcr: function startUploadAndOcr() {var _this8 = this;
    var i = this;
    this.checkNetWork(function () {
      wx.showLoading({
        title: "系统识别中",
      ...
      console.log("upfile data", o), wx.uploadFile({
        url: "".concat(BASE_URL, "/api/common/upLoadWxAppFile?BizToken=").concat(i.data.token),
        filePath: _this8.data.ocr.tempImagePath,
        name: "file",
        formData: o,
        success: function success(o) {
          if (console.log("uploadFile | ", o), 200 === o.statusCode) {
            ...
            if (0 === e.ErrorCode) {
              var _o = {
                url: "".concat(BASE_URL, "/api/ocr/ocrinfo?BizToken=").concat(_this8.data.token),
                data: {
                  MediaKey: e.Data.MediaKey,
                  PicType: _this8.data.ocr.isFrontIdCard ? 0 : 1 } };


              console.log("ocrinfo data", _o), util.request(_o, function (o) {
                if (wx.hideLoading(), 0 === o.ErrorCode) {
                  if (_this8.data.ocr.isFrontIdCard && _this8.setData({
                    "ocr.idcard": o.Data.id,
                    "ocr.idname": o.Data.name,
                    "ocr.idaddress": o.Data.address }),
                  _this8.data.ocr.isFrontIdCard && _this8.data.cmsConfig.page.ocr.backend) return void _this8.setData({
                    "ocr.tempImagePath": "",
                    "ocr.isShowPhotoPreView": !1,
                  ...
                  if (tokenExceptionArr.includes(o.ErrorCode)) return void i.exitVerifyFail(o);
                  _this8.showErrorToast(o);
                }
              });
            } else wx.hideLoading(), _this8.showErrorToast({
              ErrorCode: 101,
              ErrorMsg: e.ErrorMsg });
        ...
        fail: function fail(i) {
          console.log("upload img fail", i), wx.hideLoading(), _this8.showErrorToast({
            ErrorCode: 101,
            ErrorMsg: "上传图片失败" });
  ...
  idnameInputChanged: function idnameInputChanged(i) {
    this.data.ocr.idname = i.detail.value, this.ocrCommonInputCheck();
  },
  idcartInputChanged: function idcartInputChanged(i) {
    this.data.ocr.idcard = i.detail.value, this.ocrCommonInputCheck();
  },
  idaddressInputChanged: function idaddressInputChanged(i) {
    this.data.ocr.idaddress = i.detail.value, this.ocrCommonInputCheck();
  },
  ocrCommonInputCheck: function ocrCommonInputCheck() {
    this.setData({
      "ocr.hintErrorResult": "" });
  ...
  ocrInputGoNext: function ocrInputGoNext(i) {
    if (util.validate(this.data.ocr.idcard, "idcard")) {
      if (util.validate(this.data.ocr.idname, "idname")) {
        ...
        "ocr.hintErrorResult": "姓名格式错误" });} else

    this.setData({
      "ocr.hintErrorResult": "身份证号格式错误" });

  },
  switchLivingbodyDialog: function switchLivingbodyDialog(i) {
    this.setData({
      "livingbody.isShowDialog": !this.data.livingbody.isShowDialog });

  },
  preLivingbodyExec: function preLivingbodyExec() {var _this9 = this;
    var i = this;
    if (4 !== this.data.curPage || 0 !== this.data.cmsConfig.livingbodyType && 1 !== this.data.cmsConfig.livingbodyType)
    i.getAuth();else
    {
      var o = {
        url: "".concat(BASE_URL, "/api/liveness/lipcode?BizToken=").concat(i.data.token),
        data: {} };

      1 === i.data.cmsConfig.livingbodyType && (o.url = "".concat(BASE_URL, "/api/liveness/actioncode?BizToken=").concat(i.data.token)),
      util.request(o, function (o) {
        if (0 === o.ErrorCode) {
  ...
  authOkToDo: function authOkToDo() {
  ...
  theLivingBodyNumberMustBeOk: function theLivingBodyNumberMustBeOk() {
    var i = this;
    wx.showModal({
      title: "提示",
      ...
      success: function success(o) {
        if (o.confirm) {
          ...
          1 === i.data.cmsConfig.livingbodyType && (_o2.url = "".concat(
          BASE_URL, "/api/liveness/actioncode?BizToken=").concat(i.data.token)), util.request(_o2, function (o) {
            ...
            i.setData({
              "livingbody.livingbodyNumber": o.Data.LipCode,
              "livingbody.isNotPrepareOk": !1 });else
  ...
  livingbodyAutoShowDialog: function livingbodyAutoShowDialog() {
  ...
  livingbodyStartToRecord: function livingbodyStartToRecord() {var _this10 = this;
    this.checkNetWork(function () {
      console.log("go"), _this10.setData({
        "livingbody.isShowCamera": !0,
        isNotCamera: !1 }),
      setTimeout(function () {
        _this10.checkRecordNetworkOk(function () {
          ctx = wx.createCameraContext(), console.log("start startRecord", +new Date()), ctx.startRecord({
            success: function success(i) {
              ...
              var o = _this10.data.cmsConfig.livingbodyType,
              e = {
              ...
              a = 1200,
              s = 1e3,
              r = _this10.data.livingbody.livingbodyNumber + "",
              n = ["", "", "", ""],
              d = ["·", "·", "·", "·"],
              l = _this10.data.cmsConfig.page.livingbody.silentRecordTime - 1;
              if (0 === o) d[t] = r[t], n[t] = "verifyCurrentNumber", e["livingbody.livingbodyTitle"] = "请大声朗读以下数字",
              e["livingbody.curNumberStatus"] = n, e["livingbody.curNumber"] = d, s = 1500;else
              if (1 === o) {
                var _i = _this10.data.livingbody.isActionSeqNormal;
                e["livingbody.livingbodyTitle"] = "请做以下动作", e["livingbody.livingbodyActionText"] = _i ? "眨眨眼" : "张张嘴",
                a = 2e3;
              } else e["livingbody.livingbodySilentText"] = l, a = 1e3;
              _this10.setData(e);
              var c = setInterval(function () {
                if (0 === o) {
                  if (3 === t) return clearInterval(c), void _this10.stopRecordAndProcess(s);
                  d[++t] = r[t], n[t] = "verifyCurrentNumber", _this10.setData({
                    "livingbody.curNumberStatus": n,
                    "livingbody.curNumber": d });

                } else if (1 === o) {
                  if (1 === t) return clearInterval(c), void _this10.stopRecordAndProcess(s);
                  t++, _this10.setData({
                    "livingbody.livingbodyActionText": _this10.data.livingbody.isActionSeqNormal ? "张张嘴" : "眨眨眼" });

                } else {
                  if (0 === l) return clearInterval(c), void _this10.stopRecordAndProcess(s);
                  l--, _this10.setData({
            ...
            fail: function fail(i) {
              ...
              console.log("start record fail", +new Date(), i), _this10.showErrorToast({
                ErrorCode: -108,
                ErrorMsg: "\u7F51\u7EDC\u5F02\u5E38\uFF0C".concat(i.errMsg) });

            },
            timeoutCallback: function timeoutCallback(i) {
              console.log("timeoutCallback", i), _this10.setData({
                "livingbody.isShowGuide": !0,
                "livingbody.isShowCamera": !1,
                isNotCamera: !0,
                "livingbody.isPrepare": !0 }),
              _this10.showErrorToast({
                ErrorCode: -108,
          ...
          _this10.setData({
            ...
            "livingbody.isShowCamera": !1,
            isNotCamera: !0 }),
          _this10.showErrorToast(i);
        });
      }, 2e3);
    });
  },
  stopRecordAndProcess: function stopRecordAndProcess(i) {var _this11 = this;
        ...
        success: function success(i) {
          console.log("stopRecord success", +new Date(), i), wx.getFileInfo({
            ...
            success: function success(o) {
              ...
              e > 8192 ? (_this11.setData({
                "livingbody.isShowGuide": !0,
                "livingbody.isShowCamera": !1,
                isNotCamera: !0,
                "livingbody.isPrepare": !0 }),
              _this11.showErrorToast({
                ErrorCode: -108,
                ErrorMsg: "视频大小超过限制" })) :
              _this11.processTheVideo(i.tempVideoPath, e + "K");
            },
            fail: function fail(i) {
              _this11.setData({
                "livingbody.isShowGuide": !0,
  ...
  processTheVideo: function processTheVideo(i, o) {var _this12 = this;
    this.checkRecordNetworkOk(function (e) {
      _this12.goToProcessPage(i, o);
    }, function (e) {
      _this12.setData({
        "livingbody.isShowGuide": !0,
        "livingbody.isShowCamera": !1,
      ...
      wx.showModal({
        ...
        confirmColor: "#2d72f1",
        success: function success(e) {
          e.confirm && _this12.processTheVideo(i, o);
        } });

    });
  },
  goToProcessPage: function goToProcessPage(i, o) {
    this.setData({
    ...
    var e = {
      url: "".concat(BASE_URL, "/api/common/upLoadWxAppFile?BizToken=").concat(this.data.token),
      filePath: i,
      data: {
        file: i } };
  ...
  uploadTheVideo: function uploadTheVideo(i, o) {var _this13 = this;
    this.returnAllCheckNetWork(function (e) {
      "wifi" !== e && "none" !== e ? wx.showModal({
        ...
        confirmColor: "#2d72f1",
        success: function success(e) {
          e.confirm ? _this13.uploadTheVideoMain(i, o) : _this13.setData({
            "livingbody.isShowGuide": !0,
            "livingbody.isShowCamera": !1,
      ...
      _this13.uploadTheVideoMain(i, o);
    });
  },
  uploadTheVideoMain: function uploadTheVideoMain(i, o) {var _this14 = this;
    util.uploadFile.call(this, i, function (e) {
      if (console.log("上传视频成功"), console.log(e), 0 === e.ErrorCode) console.log("uploadSuccess"), console.log(e.Data.Data.
      MediaKey), _this14.livingbodyVerify(e.Data.Data.MediaKey);else
      {
        var t = "网络异常，上传视频失败";
        101 !== e.ErrorCode && (t = e.ErrorMsg), wx.showModal({
          ...
          confirmColor: "#2d72f1",
          success: function success(e) {
            e.confirm && _this14.uploadTheVideo(i, o);
          } });

      }
    });
  },
  livingbodyVerify: function livingbodyVerify(i) {var _this15 = this;
    var o = this.data.cmsConfig.livingbodyType,
    e = "/api/liveness/lipliveness";
    1 === o ? e = "/api/liveness/actionliveness" : 2 === o && (e = "/api/liveness/silentliveness");
    var t = {
      url: "".concat(BASE_URL).concat(e, "?BizToken=").concat(this.data.token),
      data: {
        MediaKey: i } };


    console.log(t), util.request(t, function (o) {
      if (console.log(o), 0 === o.ErrorCode) _this15.data.cmsConfig.page.success.isAutoSkip ? _this15.exitVerify({}) : _this15.setData({
        curPage: 6 });else

      if (-107 === o.ErrorCode || 101 === o.ErrorCode) wx.showModal({
        title: "提示",
        content: o.error_msg,
        showCancel: !1,
        confirmText: "重试",
        confirmColor: "#2d72f1",
        success: function success(o) {
          o.confirm && _this15.livingbodyVerify(i);
        } });else

      if (tokenExceptionArr.includes(o.ErrorCode)) _this15.exitVerifyFail(o);else
      {
        void 0 === o.ErrorCode && (o.ErrorCode = "9999", sysFailInfo[9999].tips1 = o.Data);
        var e = o.ErrorCode + "",
        t = {};
        (t = _this15.data.cmsConfig.failInfo && _this15.data.cmsConfig.failInfo[e] ? _this15.data.cmsConfig.failInfo[e] :
        sysFailInfo[e] ? sysFailInfo[e] : {
          img: "",
          msg: o.ErrorMsg,
          error_code: o.ErrorCode }).
        Data = o.Data || {}, console.log("failInfo: ", t), _this15.setData({
          failInfo: t,
          curPage: 5 });
  ...
  failReVerify: function failReVerify() {
  ...
  successGoToNext: function successGoToNext() {
    this.exitVerify({});
  },
  verifyBackToIndex: function verifyBackToIndex() {
    var i = {};
  ...
  switchfailModal: function switchfailModal() {
    this.setData({
      "failInfo.is_modal_showing": !this.data.failInfo.is_modal_showing });

  },
  ocrCameraError: function ocrCameraError(i) {
    console.log("ocrCameraError", i);
  },
  bindstop: function bindstop(i) {
    console.log(i);
  } });
